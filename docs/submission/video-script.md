...
| 8 | 3:55–4:15 | Terminal: `106 passed`. The report's metrics table. Architecture diagram. End card: GitHub URL + "Aura — your home already senses you. Privately." | "Validated live this evening: ninety-five percent presence accuracy, four out of four doorway entries detected, zero false alarms per empty hour. One hundred and six automated tests, a replayable flight-recorder pipeline, fully open source. Aura: privacy-first presence AI, from hardware you already own." |
